...
function changeArmDimens(){
    ...
    currentToolX=arm1Length+arm2TotalLength;
        ...
        //arm1
        let cubeArmExtension1p1= arm1Mesh.getObjectByName("cubeArmExtension1p1", true);
        let cubeArmExtension1p2= arm1Mesh.getObjectByName("cubeArmExtension1p2", true);
        //arm2
        ...
        arm1Mesh.getObjectByName(stlNames[2],true).position.set(armShift-additionalArm1Length, 5.1,0);
        ...
        arm2Mesh.getObjectByName(stlNames[3], true).position.set(armShift-additionalArm1Length,5.1,0);
        arm2Mesh.getObjectByName(stlNames[4], true).position.set(armShift-additionalArm1Length-additionalArm2Length,5.1,0);

        //mesh main parts
        toolMesh.getObjectByName(stlNames[5], true).position.set(armShift-additionalArm1Length-additionalArm2Length,5.1,0);
        toolMesh.getObjectByName(stlNames[6], true).position.set(armShift-additionalArm1Length-additionalArm2Length-additionalToolLength, 5.1,0);



        heightText.position.set(-3.501+(defaultArmLength*2-arm1Length-arm2Length),heightTextHeight,0);
        let percent=Math.round((currentHeight-minHeight)/(maxHeight-minHeight)*100);
        rectanglePercent = updateRectanglePercent(
            scene,              //scene
            rotation2,          //parentGroup
        ...
        heightRect.position.set(-3.5+(defaultArmLength*2-arm1Length-arm2Length),heightTextHeight,0);
...
function addAdditionalLength(){
    ...
    if(additionalToolLength>0){
        ...
        cubeToolExtension1.position.set(-3.49-additionalToolLength/2-additionalArm1Length-additionalArm2Length,0.23285,0.0035);
        ...
        cubeToolExtension2.position.set(-3.49-additionalToolLength/2-additionalArm1Length-additionalArm2Length,1.6228,0.0035);
    ...
    if(additionalArm1Length>0){
        ...
        let length = additionalArm1Length*1.5, width =1.6;
        ...
        cubeArmExtension1p2.position.set(3-(additionalArm1Length+length)/2,6.4225,width/2);
    ...
    if(additionalArm2Length>0){
        ...
        cubeArmExtension2.position.set(-2.48-additionalArm1Length-additionalArm2Length/2,4.7528,0.00385);
